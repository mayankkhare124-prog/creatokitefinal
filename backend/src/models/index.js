...
userSchema.index({ creatorScore: -1 }); userSchema.index({ role: 1 }); userSchema.index({ niche: 1 });
...
const campaignSchema = new mongoose.Schema({
  ...
  /* Core workflow — brand submits, admin assigns, creators execute */
  workflowStatus: {
    type: String,
  ...
  /* Admin assigns creators — brands never pick directly */
  assignedCreators: [{
