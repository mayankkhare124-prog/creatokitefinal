...
import { Users, Megaphone, TrendingUp, IndianRupee, Clock, Zap, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="page-enter" style={{ display:'flex', flexDirection:'column', gap:20 }}>
      ...
      <div className="grid-4">
        ...
        <StatCard label="Pending Review"  value={s.pendingCampaigns||0} icon={Clock}      color="var(--gold)" sub="Need assignment" />
